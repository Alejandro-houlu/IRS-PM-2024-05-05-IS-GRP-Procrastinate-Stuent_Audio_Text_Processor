...
bucket_name ='procrastinatebucket'
...
def upload_result(output_path, uploadId, username, location):
    s3_path = os.path.join('Procrastinate','Procrastinate '+ username,location,uploadId).replace('\\','/')
    ...
    file_url = f"https://procrastinatebucket.sgp1.digitaloceanspaces.com/{s3_path}"
